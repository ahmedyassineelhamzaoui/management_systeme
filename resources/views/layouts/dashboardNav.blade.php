            ...
            <form id="update-user-info-form" method="POST" action="{{route('users-info.update')}}">
                ...
                <!-- Modal body -->
                    <div class="p-6 space-y-6">
                        ...
                        <div class="w-100">
                            <label for="name" class="font-serif block mb-2 text-md font-bold text-gray-900 ">Nom</label>
                        ...
                        <div class="w-100">
                            <label for="email" class="mt-2 font-serif block mb-2 text-md font-bold text-gray-900 ">Email</label>
