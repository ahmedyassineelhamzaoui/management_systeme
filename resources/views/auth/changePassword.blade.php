...
<div class="login-page w-full h-screen flex justify-center items-center fixed left-0 top-0 right-0 bottom-0">
     <div class="bg-black bg-opacity-50 w-[90%] sm:w-[40%] py-4 rounded-lg">
        ...
        @if(session('error'))
        <div id="alert-border-2" class="flex mx-4 p-4 mb-4 text-red-800 border-t-4 border-red-400  role="alert">
        ...
        <form class="w-[90%] mx-auto space-y-4" action="{{route('change-password')}}"  method="POST" >
            @csrf
            <div class="w-[90%] mx-auto">
                ...
                <div class="flex items-center bg-gray-200 rounded-md">
                    ...
                    <input type="password" id="password" name="password" class="w-full py-4 text-gray-900 text-md font-bold  rounded-r-md block  px-2.5 outline-none"  placeholder="********"  required>            
                </div>
                @error('password')
            ...
            <div class="w-[90%] mx-auto">
                ...
                <div class="flex items-center bg-gray-200 rounded-md">
                    ...
                    <input type="password" id="password" name="confirm_password" class="w-full py-4 text-gray-900 text-md font-bold  rounded-r-md block  px-2.5 outline-none   " placeholder="********" required >
                </div>
