        ...
        <form class="w-[90%] mx-auto space-y-4 " action="{{route('reset')}}" method="POST" >
            ...
            <div class="w-[90%] mx-auto">
                ...
                <div class="flex items-center bg-gray-200 rounded-md">
                    ...
                    <input type="email" id="email" name="email" class="w-full text-md font-bold  text-gray-900 sm:text-sm rounded-r-md block py-4  px-2.5 outline-none " required placeholder="Entrer votre email">
                </div>
                @error('email')
