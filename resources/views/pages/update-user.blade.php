    ...
    <div class="page-content">
        ...
        <main id="main-page"> 
            <section id="my-section">   
                @if(session('info'))
                    <div id="alert-border-4" class="mx-4 flex p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50  " role="alert">
                    ...
                    <div class="bg-white rounded-lg shadow  w-full">
                        ...
                        <form action="{{route('user.update',$user->id)}}"  method="post" >
                            ...
                            <div class="mx-4 mt-6 ">
                                ...
                                @enderror
                                <div class="w-100">
                                    <label for="email" class="mt-2 font-serif block mb-2 text-md font-bold text-gray-900 ">email d'utilisateur</label>
                                ...
                                @enderror
                                <div class="w-100">
                                    <label for="role" class="mt-2 font-serif block mb-2 text-md font-bold text-gray-900 ">Role d'uitilisateur</label>
                                ...
                                <div class="w-100">
                                    ...
                                    <input type="password" value="{{$user->password}}" name="password"  id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full px-2.5 py-2 " placeholder="mot de passe">
                                </div>   
                                @error('password')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                                <div class="w-100">
                                    <label for="password" class="mt-2 font-serif block mb-2 text-md font-bold text-gray-900 ">Confirmer le mot de passe</label>
                                    <input type="password" value="{{$user->password}}" name="confirm_password"  id="confirm_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full px-2.5 py-2" placeholder="confirmer le mot de passe">
                                </div>   
