@include('layouts.dashboardHeader')
                                    ...
                                    <tr class="border-b text-tablecolor ">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-red-600 cursor-pointer" title="delete" onclick="deletMarque({{$brand->id}})" >
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="relative md:w-[60%] sm:w-[90%] h-full  md:h-auto">
            <div class="bg-white rounded-lg shadow dark:bg-gray-700 w-full">
                ...
                <form action="{{route('update.marque')}}"  method="post" >
                    ...
                    <!-- Modal footer -->
                    <div class="flex items-center justify-end p-4 mt-4 space-x-2 border-t border-gray-200 rounded-b ">
                        <button id="update-marque" type="submit" class=" text-black border-2 hover:bg-yellow-500 border-yellow-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center font-sans">Modifier</button>
                        <button id="decline-marque"  class=" text-black font-sans bg-gray-100 hover:bg-gray-300  border-2 border-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Anuller</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    {{-- delete brand  --}}
    <div id="delet-marqueForm" class="fixed z-50 hidden top-0 left-0 w-full h-full  items-center justify-center" style="background-color: rgba(0,0,0,0.5);">
        <div class="relative rounded-lg p-6 bg-white">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-medium">Confirmer la suppression</h3>
                <button class="text-gray-500 font-medium cursor-pointer close-modal" id="close-deleteMarque"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  </button>
            </div>
            ...
            <div class="flex justify-end mt-4">
                <form action="{{route('delete.marque')}}" method="post" >
                    @csrf
                    @method('DELETE')
