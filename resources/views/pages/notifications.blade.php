                ...
                @if (count($notifications) > 0)
                    <ul>
                        ...
                        <div class="w-full mt-2 flex items-center justify-between rounded-lg bg-gray-200 border-gray-300 py-3 px-4">
                          <div>
                            <div class="flex items-center"> <img class="w-10 h-10 mr-2" src="images/{{ $notification->data['picture'] }}" alt=""> <p>{{ $notification->data['user'] }} {{ $notification->data['title'] }}</p> <a class="text-blue-600 ml-2" href="{{ $notification->data['link'] }}"> voir les {{ $notification->data['pages'] }}</a> </div> 
                          ...
                          <div >
                            <button  onclick="deleteNotification('{{$notification->id}}')" class="text-red-600 cursor-pointer delete-notification">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
{{-- delete notification --}}
<div id="delete-notification" tabindex="-1" class="fixed z-50 hidden top-0 left-0 w-full h-full  items-center justify-center bg-black bg-opacity-20" >
