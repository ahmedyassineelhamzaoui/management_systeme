            ...
            <section id="my-section">
                <div>
                    <div class="flex w-full justify-end">
                        <button data-modal-target="import-product" data-modal-toggle="import-product" class="block w-full md:w-auto text-white mr-2 bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center " type="button">
                            importer produits
                        </button>
                        <a class="text-white px-4 py-1 flex items-center rounded-lg mr-2 bg-red-500" href="{{ route('product.export') }}">Exporter les produits</a>
