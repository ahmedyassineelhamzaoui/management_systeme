                                ...
                                <tr class="border-b text-tablecolor ">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            ...
                                            <button onclick="deleteProduct({{ $product->id }})" data-modal-target="delete-product"   class="text-red-600 cursor-pointer delete-product">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div class="relative rounded-lg p-6 bg-white">
        ...
        <div class="flex justify-end mt-4">
            <form method="post" action="{{route('delete.product')}}">
                ...
                <button data-modal-hide="delete-product" type="button" class="px-4 py-2 rounded-md text-white bg-gray-600 close-modal"  >Anuller</button>
