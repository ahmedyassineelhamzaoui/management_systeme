                                ...
                                <tr class="border-b text-tablecolor ">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            ...
                                            <button data-modal-toggle="delete-product"  data-modal-target="delet-product"  class="text-red-600 cursor-pointer ">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
{{-- delete product --}}
     <div id="delet-product" tabindex="-1" class="fixed z-50 hidden top-0 left-0 w-full h-full  items-center justify-center" >
        <div class="relative rounded-lg p-6 bg-white">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-medium">Confirmation</h3>
                <button data-modal-hide="delet-product" class="text-gray-500 font-medium cursor-pointer close-modal" id="close-deletedModal"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="flex justify-end mt-4">
                <form method="post" >
                    @csrf
                    @method('delete')
                    <button data-modal-hide="delet-product" type="button" class="px-4 py-2 rounded-md text-white bg-gray-600 close-modal"  >Cancel</button>
