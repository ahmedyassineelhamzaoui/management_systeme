        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-700 ">
            ...
            <form>
                ...
                <div class="flex items-center justify-end p-4 mt-4 space-x-2 border-t border-gray-200 rounded-b ">
                    <button  type="submit" wire:click.prevent="store()" class=" text-black border-2 hover:bg-green-500 border-green-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center font-sans">Create</button>
